...
class ResidualPlotter():
    def __init__(self, xs, expected_ys, cov,
                 ...
                 binned_data_color=default_binned_color,
                 err_color=default_err_color):
        # Set color options
        self.expected_color = expected_color
        self.binned_data_color = binned_data_color
    ...
    def add_data(self, data, label=None, color=None,
                 plot_binned=True, binned_color=None, **plot_args):
        '''
        Adds a data set to be plotted.

        data: A 1D array, same shape as `self.xs`. The data set to be plotted.
        data_label: The display label for this data set. Optional.
        data_color: Color to display this data set as. Optional.
        '''
        self.datasets.append(DataSet(self, data, label=label, color=color,
                                     plot_binned=plot_binned, binned_color=binned_color,
                                     **plot_args))
...
class DataSet:
    def __init__(self, parent, data, label, color, plot_binned=True, binned_color=None, **plot_args):
